            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                {this.state.category.map(cat => 
                  <li><a class="dropdown-item" href="/product-category" onClick={() => { this.selectcategory(cat.categoryId, cat.name) }} >{cat.name}</a></li>
            ...
            {this.state.st && window.localStorage.getItem("user_role") == 'ADMIN' && 
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" href="/add-medicine">Add Medicine</a></li>
