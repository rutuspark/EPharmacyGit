...
import ShowProductsScreen from './screens/admin/ShowProductsScreen';
    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route path="/add-medicine" component={AddProductScreen}/>
          <Route path="/show-medicine" component={ShowProductsScreen}/>
          <Route path="/update-medicine/:id" component={UpdateProductScreen}/>
          ...
          <Route path="/userOrderDetails" component={UserDetailsScreen}/>
          ...
          <Route path="/showproducts" component={ShowProductsScreen}/>
